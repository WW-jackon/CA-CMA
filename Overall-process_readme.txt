...
step 2:  Feature extraction
    ...
    (2) behavior:   Behavior feature extraction
        Doc2vec--->CMI-9859/CMI-9905/CMI-20208: Use Doc2vec to get 64-dimensional Behavior feature
    (3) Kmer-9905
        the feature vector generated by k-mer frequencies and probability

step 3:  Model training and prediction
    (1)A+B: Training and prediction of CA-CMA model
        5fold_CNN_DNN-9859_CNN
            1) 0/1/2/3/4:
                The prediction of the training of each model
            2) draw:
                Draw the ROC curve and PR curve of the relevant model
        5fold_CNN_DNN-9905_CNN
            1) 0/1/2/3/4:
                The prediction of the training of each model
            2) draw:
                Draw the ROC curve and PR curve of the relevant model
        ...
        5fold_CNN_DNN-9905_CNN_CLF
            1) 0/1/2/3/4:
                The prediction of the training of each model
            2) AdaBdraw/GBDTdraw/KNNdraw/LRdraw/RFdraw/SVMdraw:
                Draw the ROC curve and PR curve of the relevant model
        5fold_CNN_DNN-9905_PCA
            1) 0/1/2/3/4:
                The prediction of the training of each model
            2) draw:
                Draw the ROC curve and PR curve of the relevant model
        5fold_CNN_DNN-20208
            ...
            2) draw:
                Draw the ROC curve and PR curve of the relevant model
        Kmer_CNN_DNN-9905_CNN
            1) 0/1/2/3/4:
                The prediction of the training of each model
            2) draw:
                Draw the ROC curve and PR curve of the relevant model
    (2)A:   Training and prediction of CA-CMA-A model
        1) 0/1/2/3/4:
                The prediction of the training of each model
        2) draw:
                Draw the ROC curve and PR curve of the relevant model
    (3)B:  Training and prediction of CA-CMA-B model
         1) 0/1/2/3/4:
                The prediction of the training of each model
         2) draw:
                Draw the ROC curve and PR curve of the relevant model
