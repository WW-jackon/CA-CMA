...
def train_doc2vec_model(seq_list, model_name):
    ...
    model = gensim.models.doc2vec.Doc2Vec(vector_size=64, min_count=3, epochs=100, workers=12)
...
if __name__ == '__main__':
    ...
    lncrna_dict = read_fa("circBaseSequence.fasta") 
    lncrna_list = list(lncrna_dict.values())
    train_doc2vec_model(lncrna_list, "circRNA_doc2vec_test")
